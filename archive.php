...
<div class="container">
  ...
  <script>
    document.getElementById('search-bar').addEventListener('input', function () {
        ...
        items.forEach(item => {
            // Get only the text content of `.filename` and `.filedata` for searching
            const filenameText = item.querySelector('.filename')?.textContent.toLowerCase() || '';
            const filedataText = item.querySelector('.filedata')?.textContent.toLowerCase() || '';

            // Match search text with filename and filedata
            if (filenameText.includes(searchText) || filedataText.includes(searchText)) {
